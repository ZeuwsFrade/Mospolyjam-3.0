...
func _process(delta: float) -> void:
	if type == "Farm":
		...
		Description = "Это жилой отсек. Здесь можно разместить до 5 человек. 
		Для поддержания его работы требуется 2 энергии."
	elif type ==  "Engine":
		Name.text = "Двигатели"
		Icon.texture = load("res://Assets/Icons/Engine_icon.png")
		Description = "Это дополнительные двигатели. 
		...
		Description = "Это НИИ. Здесь учёные в срочном порядке расшифровывают чертежи. 
		...
		Description = "Это инженерный отсек. Здесь производят экстренные улучшения вашего костюма.
		...
		Description = "Это экспериментальный репликатор. 
